...
<div class="h-[70vh] bg-gray-300 flex items-center">
	<section class="w-full bg-cover bg-center py-32" style="background-image: url('https://source.unsplash.com/random/a');">
		<div class="container mx-auto text-center text-white">
			<h1 class="text-5xl  mb-6 text-gray-800 text-opacity-40 font-extrabold">Find The Best location For Your Vaccation</h1>
    ...
    <div id="container" class="container mx-auto px-4 py-8 w-full h-[80vh] bg-slate-400">
        @foreach ($rentals as $rental)
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 outline">
                <h1 class="text-3xl font-bold mb-2">{{ $rental->title }}</h1>
                <div class="rounded-lg overflow-hidden shadow-md w-[20vw] ">
                    <div class="w-[80%]">
                        <img src="{{ asset('storage/img/' . $rental->imgs) }}" width="400" class=" "
                    alt="{{ $rental->title }}" />
                    </div>
                    <div class="p-4">
                ...
                <div class="">
                    ...
                    <p class="text-gray-700 mb-4">**Note:** This is just a sample price. You may need to implement logic
                        for
