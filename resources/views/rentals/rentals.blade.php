...
<div class="h-[70vh] bg-gray-300  flex items-center">
	<div class="w-full bg-cover bg-center h-[100%] py-32" style="background-image: url('https://source.unsplash.com/random/c');">
    ...
    <div id="container" class="container mx-auto px-4 py-8 w-full h-fit  bg-slate-400">
